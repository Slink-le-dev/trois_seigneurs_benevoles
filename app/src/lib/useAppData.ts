...
export function useAppData(isAdmin: boolean, currentUserId: string | null = null, currentUserLabel: string | null = null, evenementId: string | null = null) {
  ...
  const [settings, setSettings] = useState<AppSettings>({ show_denivele: true, show_gpx_download_participant: true, show_gpx_download_benevoles: true, organisateur_nom: '', couleur_principale: '#00C389', couleur_secondaire: '#F3EA5D', couleur_tertiaire: '#374151', logo_url: null, telephone_pc_securite: '' });
